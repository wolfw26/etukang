    ...
    <div class="row">
        ...
        <div class="col">
            <div class="card p-0">
                ...
                <div class="card-body text-center  active" id="satu">
                ...
                <div class="form-floating mb-3 mt-1" id="dua">
                    @foreach ( $ahsp as $d )
                    <div class="card card-navy card-outline pb-0">
                        <div class="card-header">
                            <div class="row">
                                ...
                                <div class="col-6"><i>{{ $d->nama_ahs }}</i> </span></div>
                                <div class="col">
                        ...
                        <div class="card-body bg-gray-light collapse" id="{{ (string)$d->id}}" >
                            ...
                            <div class="row">
                                <div class="col">{{ $d->ahspdata->rincian }}</div>
                                {{-- <div class="col">{{ $d->ahspdata->volume }} {{ $d->ahspdata->satuan }}</div>
                                <div class="col">{{ $d->ahspdata->harga_satuan }}</div>
                                <div class="col">{{ $d->ahspdata->total }}</div> --}}
                            </div>
                        </div>
                        @endforeach
                        <!-- /.card-body-->
