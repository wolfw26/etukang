            ...
            <tbody>
                ...
                <tr class="text-center">
                    ...
                    <td class="project-actions text-right">
                        ...
                        <a class="badge badge-info btn-sm" href="#" data-toggle="modal" data-target="#UpdateTukang">
...
<!-- /modal -->
<!-- Modal Edit -->
<div class="modal fade" id="UpdateTukang" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header  bg-blue">
                <h5 class="modal-title" id="exampleModalLabel">Update Data Client</h5>
            </div>
            <div class="modal-body">
                <form action="/adm/tukang" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-6">
                            <div class="form-floating mb-3 mt-3">
                                <label for="nama">1. Nama </label>
                                <input type="text" class="form-control @error('nama') is-invalid @enderror" id="nama" placeholder="Nama Tukang" name="nama" value=" {{ old('nama', $data) }} ">
                                @error('nama')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
