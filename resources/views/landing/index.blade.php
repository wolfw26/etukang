          ...
          <div id="particles-js" class="banner" >
             <div class="font">
                 ...
                 <button class="button_login"> 
                    <a style="text-decoration : none; font-weight : 100;" href="/login">MASUK</a>
                </button>
    ...
    <section class="news" id="news">
		...
		<div class="services-cards">
			<div class="services-card">
				<img src="{{asset('img/pexels-destiawan-nur-agustra-1011509.jpg')}}" alt="">
				<div class="text">
			...
			<div class="services-card">
				<img src="{{asset('img/pexels-lucas-souza-1960183.jpg')}}" alt="">
				<div class="text">
			...
			<div class="services-card">
				<img src="{{asset('img/pexels-marcelo-chagas-1845732.jpg')}}" alt="">
				<div class="text">
