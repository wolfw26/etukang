                        ...
                        <div class="row">
                            ...
                            <div class="col-4">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input wire:model="sisa" type="number" class="form-controol form-control-sm" readonly>
                                </div>
                            ...
                            <table class="table table-head-fixed text-nowrap table-bordered">
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col">Dibayar <br> Sisa Bayar</th>
                                    </tr>
                                </thead>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td scope="col">{{ 'Rp. '. number_format($d->dibayar) }} <br> {{'Rp. '. number_format($d->sisa) }}</td>
                                    </tr>
                                    <!-- Modal -->
